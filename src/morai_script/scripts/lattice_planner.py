...
class latticePlanner:
    def __init__(self):
        ...
        # REJOIN
        self.rejoin_clear_m      = g("~rejoin_clear_m", 2.5)
        self.rejoin_clear_frames = g("~rejoin_clear_frames", 2)
        ...
        self.avoid_low_speed_block_mps = float(g("~avoid_low_speed_block_mps", 1.0))
