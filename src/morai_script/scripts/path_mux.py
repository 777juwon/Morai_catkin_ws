...
class PathMux:
    def __init__(self):
        ...
        self.nolattice_zone_enabled = bool(rospy.get_param("~nolattice_zone_enabled", True))
        ...
        self.nolattice_start_radius_m = float(rospy.get_param("~nolattice_start_radius_m", 4.5))
